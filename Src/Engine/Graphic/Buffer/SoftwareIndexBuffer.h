 ...
 *
 */
#ifndef     _SOFTWARE_INDEX_BUFFER_H_
#define     _SOFTWARE_INDEX_BUFFER_H_
...
/**
 *  Software IndexBuffer class
 */
class ENGINE_API SoftwareIndexBuffer : public IndexBuffer
{
    DECLARE_CLASS(SoftwareIndexBuffer,IndexBuffer);
...
#endif  //  _SOFTWARE_INDEX_BUFFER_H_