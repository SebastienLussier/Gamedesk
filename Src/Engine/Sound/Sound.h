...
{
    DECLARE_ABSTRACT_CLASS(Sound, Resource);
...
public:
    ...
    enum eSoundMode
    {
        kSoundModeOneShot,  //!< One shot sound.
        kSoundModeLoop      //!< Forward looping sound.        
    };

    //! Sound constants enum.
    enum eSoundConstant
    {
        kStereoPan          //!< Makes the pan full/full instead of 50/50
    };
