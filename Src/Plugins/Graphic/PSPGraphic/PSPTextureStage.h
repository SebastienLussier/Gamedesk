 ...
 *
 */
#ifndef     _PSP_TEXTURE_STAGE_H_
#define     _PSP_TEXTURE_STAGE_H_
...
class PSPTextureStage : public TextureStage
{
    CLASS_DISABLE_COPY(PSPTextureStage);

public:
    PSPTextureStage( UInt32 pStage );
    virtual ~PSPTextureStage();
