 ...
 *
 */
#ifndef     _FMOD_SOUND_SUBSYSTEM_H_
#define     _FMOD_SOUND_SUBSYSTEM_H_
...
class FMODSOUND_API FMODSoundSubsystem : public SoundSubsystem
{
    DECLARE_CLASS(FMODSoundSubsystem, SoundSubsystem);

public:
    FMODSoundSubsystem();
    virtual ~FMODSoundSubsystem();
    ...
    virtual Bool StartSoundSystem();
    //! Stop the sound system.
    virtual Bool StopSoundSystem();
...
private:
    Int32                        mOutputRate;
    Int32                        mMaxNbSoftwareChannels;
    SoundSubsystem::eOutputType  mOutputType;
    SoundSubsystem::eMixerType   mMixerType;
    SoundSubsystem::eSpeakerMode mSpeakerMode;
};


#endif  //  _FMOD_SOUND_SUBSYSTEM_H_
