...
namespace GDEdit
{
    ...
    public class WpfPropertyGrid : Grid
    {
        ...
        public WpfPropertyGrid()
        {
            ...
            var props = inspectorType.GetProperties(System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance |
            ...
            this.SelectionTypeLabel = inspectorType.GetMethod("get_SelectionTypeLabel",
                ...
                System.Reflection.BindingFlags.DeclaredOnly).Invoke(inspector, new object[0]) as TextBlock;
            ...
            //if (args.OriginalSource is TextBlock)
            {
                ...
                if (this.TheSelectedObjects != null && this.TheSelectedObjects.Length > 0)
                {
                    ...
                    if (propEntry != null)
                    {
                        ...
                        Type propType = propEntryValue.GetType();
                        PropertyInfo propInfo = propType.GetProperty("SubPropertyHierarchyPath");
                        string propPath = propInfo.GetValue(propEntryValue, null) as string;
                        
                        char[] charSeparators = new char[] { ',' };
                        string[] propertiesNames = propPath.Split(charSeparators, StringSplitOptions.RemoveEmptyEntries);
                        PropertyInfo property = null;
                        foreach (string propName in propertiesNames)
                        {
                            if(property == null)
                                property = this.TheSelectedObjects[0].GetType().GetProperty(propName);
                            else
